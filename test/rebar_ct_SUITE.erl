...
cmd_vs_cfg_opts(Config) ->
    ...
    % this is different from the testing pattern prevalent in this file, but easier to debug
    true = lists:keymember(group, 1, TestOpts3),
    {group, [[g1,g2],[g3]]} = lists:keyfind(group, 1, TestOpts3),
